...
<head>
  ...
  <meta name="description" content="UX_Design">
  <meta name="author" content="Team Bangkok">
  <!-- styles -->
...
<body>
    ...
    <div id="navigation" class="navbar navbar-inverse navbar-fixed-top default" role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" class="scrollup">UX Design Process</a>
        </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <nav>
              <ul class="nav navbar-nav navbar-right">
                <li><a href="#about">What is UX</a></li>
  ...
  <section> 
    <ul id="slippry-slider">
      ...
      <li>
        <a href="#slide1"><img src="assets/img/slide/1.jpg" alt="UX Design"></a>
      </li>
      <li>
        <a href="#slide2"><img src="assets/img/slide/2.png" alt="User Research"></a>
      </li>
      <li>
        <a href="#slide3"><img src="assets/img/slide/3.png" alt="Wireframing"></a>
      </li>
      <li>
        <a href="#slide3"><img src="assets/img/slide/4.png" alt="Prototyping"></a>
      </li>
      <li>
        <a href="#slide3"><img src="assets/img/slide/5.jpg" alt="Testing"></a>
      </li>
      <li>
        <a href="#slide3"><img src="assets/img/slide/6.jpg" alt="Evaluation"></a>
      </li>
    </ul> 
  </section>
...
<!-- Section wireframing -->
  <section id="wireframing" class="section">
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="heading">
  ...
  <!-- end section wireframing -->
  
<!-- section prototyping -->
  <section id="prototyping" class="section gray">
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="heading">
            <h3><span>Prototyping</span></h3>
          </div>
          <div class="sub-heading">
            <p>In the prototyping phase, designers create a draft version of the site or product. Aspects of prototyping may include:</p>
            <ul>
          ...
          <p> Prototyping generally occurs before any coding can begin.</p>
          </div>
        </div>
      </div>
    </div>
  </section>
  <!-- end section prototyping -->
...
<!-- section evaluation -->
  <section id="evaluation" class="section gray">
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="heading">
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <div class="heading">
            ...
            <a href="survey.php" class="button1">Survey Button</a></p>
          </div>
        </div>
      </div>
</div>         
